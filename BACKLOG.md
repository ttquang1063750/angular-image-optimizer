...
1.  **Chuyển đổi sang WebP/AVIF (Hoàn thành ✅):**
    *   Thêm tùy chọn xuất ra định dạng WebP (mặc định cho web hiện đại).
    *   Nghiên cứu tích hợp AVIF cho chất lượng nén cao nhất.
2.  **Tính năng Resize hàng loạt (Bulk Resize):**
